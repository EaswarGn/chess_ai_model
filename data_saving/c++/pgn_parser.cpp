...
class MyVisitor : public pgn::Visitor {
   private:
    ...
    std::vector<int> white_clock_times;
    std::vector<int> black_clock_times;
    std::vector<int> white_elapsed_times;
    std::vector<int> black_elapsed_times;
