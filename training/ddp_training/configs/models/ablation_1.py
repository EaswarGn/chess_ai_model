...
class CONFIG:
    def __init__(self):
        ...
        self.STEP = None#None #the step to start training at, if None then step will start at 1 even after loading from checkpoint
        ...
        self.CHECKPOINT_PATH = None#'full_trained_model/checkpoints/models/1900_step_2000.pt'#'../../../averaged_CT-EFT-20.pt'
