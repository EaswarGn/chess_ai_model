...
from models import EnhancedChessTransformer
from utils import *
import os
import sys
...
def train_model(CONFIG):
    ...
    # Model
    model = EnhancedChessTransformer(CONFIG)
    ...
    for epoch in range(epochs):
        ...
        """train_loader = DataLoader(
            dataset=ChessDataset(
                data_folder=f'../data/epoch_{epoch+1}/train_data',
                h5_file='data.h5',
                split="train",
        ...
        val_loader = DataLoader(
            dataset=ChessDataset(
                data_folder=f'../data/epoch_{epoch+1}/val_data',
                h5_file='data.h5',
                split="val",
                n_moves=CONFIG.N_MOVES,
            ),
        ...
        train_loader = DataLoader(
            dataset=ChessDataset(
                data_folder=f'../../../../drive/My Drive/data/epoch_{epoch+1}/train_data',
                h5_file='data.h5',
                split="train",
                n_moves=CONFIG.N_MOVES,
            ),
        ...
        val_loader = DataLoader(
            dataset=ChessDataset(
                data_folder=f'../../../../drive/My Drive/data/epoch_{epoch+1}/val_data',
                h5_file='data.h5',
                split="val",
                n_moves=CONFIG.N_MOVES,
            ),
    ...
    for i, batch in enumerate(train_loader):
        ...
        with torch.autocast(
            ...
            if CONFIG.NAME.startswith(("CT-ED-", "CT-E-")):
                ...
                #print(f"time taken to process one batch: {elapsed:.4f}s")
                ...
                elapsed = time.time() - start
                #print(f"time taken for loss calculation: {elapsed:.4f}s")
        ...
        del batch
        print("memory before clearing cache:",torch.cuda.memory_allocated())  # Before clearing cache
        torch.cuda.empty_cache()
        print("memory after clearing cache:",torch.cuda.memory_allocated())
